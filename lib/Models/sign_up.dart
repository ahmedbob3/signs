...
class Data {
    ...
    factory Data.fromMap(Map<String, dynamic> json) => Data(
        ...
        uBirthDate: DateTime.parse(json["u_birth_date"]),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "u_email": uEmail,
        "u_gender": uGender,
        "u_birth_date": "${uBirthDate.year.toString().padLeft(4, '0')}-${uBirthDate.month.toString().padLeft(2, '0')}-${uBirthDate.day.toString().padLeft(2, '0')}",
        "u_weight": uWeight,
        "u_height": uHeight,
        "u_bed_time": uBedTime,
        "u_wake_up": uWakeUp,
