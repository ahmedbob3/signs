...
class MedicationsModel {
    ...
    factory MedicationsModel.fromJson(String str) => MedicationsModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory MedicationsModel.fromMap(Map<String, dynamic> json) => MedicationsModel(
        code: json["code"],
        status: json["status"],
...
final mfNameValues = EnumValues({
    "Capsules": MfName.CAPSULES,
    "Tablet": MfName.TABLET
});
