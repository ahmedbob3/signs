...
class SignupScreenStep1 extends StatefulWidget {
  ...
  SignupScreenStep1({Key key, this.phoneNumber = '', this.countryCode = ''}) : super(key: key);
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: CountryCodePicker(
                                      ...
                                      initialSelection: CountryCodes.dialCode(),
                                      favorite: ['+20', '+965'],
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      widget.countryCode == '' ? selectedCountry : widget.countryCode ,
                                      style: titleStyle(
                                          fontFamily: mediumFontFamily,
                                          color: Colors.black,
                                          fontSize: 17),
