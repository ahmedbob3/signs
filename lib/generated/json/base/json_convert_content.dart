...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
			...
			case DoctorTimeSlot:
				return doctorTimeSlotsDataFromJson(data as DoctorTimeSlot, json) as T;
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {
			...
			case DoctorTimeSlot:
				return doctorTimeSlotsDataToJson(data as DoctorTimeSlot);
			case BannersResponseEntity:
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		if(type == (DoctorsEntity).toString()){
